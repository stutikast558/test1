...
The Scatter plots of Sepal Length vs Sepal Width and Petal Length vs Petal Width below provides the information on how the length is affected by the width and vice versa. The green line shows the linear trend and greay area around the green line gives the confidence region.
